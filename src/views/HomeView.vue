...
<template>
  <div class="max-w-[1500px] mx-auto">
    <div class="px-8 mt-8 win-w-[800px] w-full">
      <div class="text-white text-xl font-semibold inline-block">
        Mixes inspired by...
        <div class="text-sm font-light text-[#A2A2AD]"> Discover new tracks similar to your favorites</div>
      </div>
      ...
      <div class="py-3"></div>
        <div class="flex justify-between w-full gap-8">
          <div class="xl:w-1/3 w-1/2">
            <MixesInspiredBy
              class="pb-1.5"
              text="VAMPIRE (feat. Oli Sykes of Bring Me The Horizeon)"
              by="Ic3peak"
              to="/artist"
        ...
        <div class="py-3"></div>
          <div class="flex justify-start gap-7">
            <MultiArtistSelect
              class="w-1/4"
              category="daily"
              text="Featuring Bring Me the Horizon, Our Last Night, Bad Omens, The Retaliator"
              to="/artist"
              :images="{
      ...
      <div class="px-8 mt-8 min-w-[800px]">
        <div class="py-3"></div>
        <p class="text-center pb-6 text-[#D1D1D6]">
          Unlock Flow by selecting your favorite artists for improved recommendations.
        </p>
