        ...
        >
          <div 
            ...
            <div 
              ...
              >
              <img width="80" class="pr-2 opacity-[0.75] brightness-[1.2]" src="/images/playonic-high-resolution-logo-transparent.png" alt="" />
              <div class="text-white font-semibold text-[21px]">{{ category }}</div>
            </div>
      </div>
    </RouterLink>
    <div class="h-2"></div>
